...
- `:backend` process: `ListenerService` (declared `android:process=":backend"` at `/media/user/Lobotomite/Repository/AI/clients/glasses/app/src/main/AndroidManifest.xml:125-128`). All wake-word work runs here -- `WakeWordPipeline` is constructed by `ListenerService.onCreate` so it lives in `:backend`.
...
- `WakeWordPipeline` (entry, `:backend`) -- `/media/user/Lobotomite/Repository/AI/clients/glasses/app/src/main/java/com/repository/glasses/listener/wakeword/WakeWordPipeline.kt:75-965`. Public API: `start()`, `stop()`, `isRunning()`, `injectPcmFile(path)` (debug only).
- `AcdNativeDetector` -- `/media/user/Lobotomite/Repository/AI/clients/glasses/app/src/main/java/com/repository/glasses/listener/wakeword/AcdNativeDetector.kt`. Skipped entirely when `useNativeAcd=false`; the pipeline subscribes to MicBus directly.
...
- `/media/user/Lobotomite/Repository/AI/clients/phone/app/src/main/java/com/repository/listener/ui/GlassesSettingsActivity.kt` (UI row + send)
- `/media/user/Lobotomite/Repository/AI/clients/phone/app/src/main/java/com/repository/listener/ui/GlassesSettingsFragment.kt` (UI row, if fragment-backed)
- `/media/user/Lobotomite/Repository/AI/clients/phone/app/src/main/java/com/repository/listener/bt/PhoneBtHost.kt:1594-1608` (include key in full snapshot)
- `/media/user/Lobotomite/Repository/AI/clients/glasses/app/src/main/java/com/repository/glasses/listener/config/GlassesConfig.kt` (var + load/save/applySettings)
- `/media/user/Lobotomite/Repository/AI/clients/glasses/app/src/main/java/com/repository/glasses/listener/service/ListenerService.kt:2844-2850` (boot gate)
- `/media/user/Lobotomite/Repository/AI/clients/glasses/app/src/main/java/com/repository/glasses/listener/service/ListenerService.kt:3541` (`reconcileWakeWord` -- add `&& wakeWordEnabled` to `needed`)
- `/media/user/Lobotomite/Repository/AI/clients/glasses/app/src/main/java/com/repository/glasses/listener/service/ListenerService.kt:5670-5688` (`onSettings` -- call `setWakeWordEnabled` after `applySettings`)
